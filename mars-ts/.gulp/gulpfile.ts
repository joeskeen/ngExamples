...
gulp.task('buildServer', () => build.js(config.all('ts', config.server.root), config.out.serverBuilt));
gulp.task('runServer', ['buildServer', 'watch-client', 'watch-server'], () => $.nodemon({
